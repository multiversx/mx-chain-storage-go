...
type LatestStorageDataProviderStub struct {
	...
	GetCalled                      func() (elrond_go_storage.LatestDataFromStorage, error)
...
// Get -
func (lsdps *LatestStorageDataProviderStub) Get() (elrond_go_storage.LatestDataFromStorage, error) {
	if lsdps.GetCalled != nil {
		return lsdps.GetCalled()
	}

	return elrond_go_storage.LatestDataFromStorage{}, nil
}
