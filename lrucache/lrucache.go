...
// SetCallHandlersSyncMode sets the mode the handlers are called (synced or async)
func (c *lruCache) SetCallHandlersSyncMode(inSync bool) {
	c.mutAddedDataHandlers.Lock()
	c.callHandlersInSync = inSync
